...
export type ScenarioPreset = '1710' | '1758' | '1813';
...
export const ORDER_IDS = {} as const;
...
export const elephantBorderClockwise: Record<string, ElephantState[]> = {
  [REGION_IDS.PUNJAB]: [
    { tailRegion: REGION_IDS.PUNJAB, headRegion: REGION_IDS.DELHI },
    { tailRegion: REGION_IDS.PUNJAB, headRegion: REGION_IDS.BOMBAY },
  ],
  [REGION_IDS.DELHI]: [
    { tailRegion: REGION_IDS.DELHI, headRegion: REGION_IDS.BENGAL },
  ...
  [REGION_IDS.BENGAL]: [
    { tailRegion: REGION_IDS.BENGAL, headRegion: REGION_IDS.MARATHA },
    { tailRegion: REGION_IDS.BENGAL, headRegion: REGION_IDS.DELHI },
  ],
  [REGION_IDS.BOMBAY]: [
    { tailRegion: REGION_IDS.BOMBAY, headRegion: REGION_IDS.PUNJAB },
  ...
  [REGION_IDS.MARATHA]: [
    { tailRegion: REGION_IDS.MARATHA, headRegion: REGION_IDS.DELHI },
...
/*
  ...
  SCENARIO PRESETS
  =========================
  1710 uses initialRegions / initialOrders / initialElephantState
  1758 and 1813 currently start as copies of 1710.
  Replace the marked values below with the real setup differences.
*/

// 1758 preset
export const initialOrders1758: Record<string, Order> = structuredClone(initialOrders);
export const initialRegions1758: Record<RegionId, Region> = structuredClone(initialRegions);
export const initialElephantState1758: ElephantState = {
  ...initialElephantState,
};

// Example edits for 1758:X
    initialOrders1758['8'].open = true;
    initialOrders1758['11'].open = true;
    initialOrders1758['16'].open = false;
    initialOrders1758['15'].open = false;
    initialRegions1758[REGION_IDS.PUNJAB].towerHeight = 1;
    initialRegions1758[REGION_IDS.MYSORE].towerHeight = 2;
    initialRegions1758[REGION_IDS.BOMBAY].towerHeight = 2;
    initialRegions1758[REGION_IDS.BENGAL].companyControlled = true;
    initialElephantState1758.tailRegion = REGION_IDS.DELHI;
    initialElephantState1758.headRegion = REGION_IDS.BENGAL;

// 1813 preset
export const initialOrders1813: Record<string, Order> = structuredClone(initialOrders);
export const initialRegions1813: Record<RegionId, Region> = structuredClone(initialRegions);
export const initialElephantState1813: ElephantState = {
  ...initialElephantState,
};

// Example edits for 1813:
   initialOrders1813['8'].open = true;
   initialOrders1813['13'].open = true;
   initialOrders1813['5'].open = false;
   initialOrders1813['6'].open = false;
   initialRegions1813[REGION_IDS.BENGAL].companyControlled = true;
   initialRegions1813[REGION_IDS.MADRAS].companyControlled = true;
   initialRegions1813[REGION_IDS.BOMBAY].companyControlled = true;
   initialRegions1813[REGION_IDS.PUNJAB].towerHeight = 2;
   initialRegions1813[REGION_IDS.MYSORE].towerHeight = 2;
   initialRegions1813[REGION_IDS.PUNJAB].towerHasFlag = false;
   initialRegions1813[REGION_IDS.DELHI].towerHasFlagStar = false;
   initialRegions1813[REGION_IDS.MARATHA].towerHasFlag = false;
   initialElephantState1813.tailRegion = REGION_IDS.MYSORE;
   initialElephantState1813.headRegion = REGION_IDS.MADRAS;
...
export const scenarioPresets: Record<ScenarioPreset, ScenarioSetup> = {
  '1710': {
    year: 1710,
    turn: 1,
  ...
  '1758': {
    year: 1758,
    turn: 1,
    regions: initialRegions1758,
    orders: initialOrders1758,
    elephant: initialElephantState1758,
  },
  '1813': {
    year: 1813,
    turn: 1,
    regions: initialRegions1813,
    orders: initialOrders1813,
    elephant: initialElephantState1813,
  },
};

export function getInitialState(preset: ScenarioPreset = '1710'): GameState {
  const setup = scenarioPresets[preset];

  return {
    phase: 'company',
    regions: structuredClone(setup.regions),
    orders: structuredClone(setup.orders),
    ...
    year: setup.year,
    history: [],
    elephant: structuredClone(setup.elephant),
    stormDie: 'none',
...
export const initialState: GameState = getInitialState('1710');